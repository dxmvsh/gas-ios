...
class BottomSheetContainerViewController<Content: UIViewController, BottomSheet: UIViewController>: BaseViewController {
    ...
    private func setupUI() {
        ...
        bottomSheetViewController.view.roundCorners(radius: 25, corners: [.layerMinXMinYCorner, .layerMaxXMinYCorner])
